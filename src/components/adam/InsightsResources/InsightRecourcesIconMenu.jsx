  ...
  return (
    <LayoutScreen>
            <section className=' flex items-center justify-center -mt-20 flex-col h-full mb-60  ' >
                <h1 className='text-6xl text-center h-[120px] text-transparent bg-clip-text tracking-wide bg-gradient-to-r from-[#d24df0] to-[#914df7] font-bold mb-10' >Insights & Resources</h1>
                <div className='sm:flex items-center grid grid-cols-2 mt-5 sm:mt-0 gap-5' >
                {
                    iconMenu.map((val, index) => (
                        <div key={index} className='flex cursor-pointer items-center flex-col gap-5 sm:w-[280px] sm:h-[219px] h-[150px] w-[150px] shadow-lg    justify-center rounded-lg ' > 
                            <span className='sm:w-20 w-20 flex items-center justify-center sm:h-20 h-20 rounded-full bg-gradient-to-br from-[#e24ced] to-[#814dfa] ' >
                                {val.icon}
                            </span>
                            <h1 className='font-bold sm:text-xl text-center text-base ' >{val.title}</h1>
                        </div>
                    ))
                }
                </div>
