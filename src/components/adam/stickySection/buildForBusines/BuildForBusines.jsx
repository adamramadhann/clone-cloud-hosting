...
//     const visibleCardLength = [
//         ...dataBuild.slice( currentCard,currentCard + visibleCard ),
//         ...dataBuild.slice( 0, Math.max(0, (currentCard + visibleCard ) - dataBuild.length))
//     ]


//     useEffect(() => {
//         const interval = setInterval(() => {
//             setCurrentCard((prev) => (prev + 1) % dataBuild.length)
//         }, 3000)
...
//             <section id="buildForBusines"  className=' flex items-center justify-center flex-col h-full  ' >
//                 <h1 className='text-6xl h-[120px] text-transparent bg-clip-text tracking-wide bg-gradient-to-r to-[#fd4df6] from-[#fda14d] font-bold mb-5' >Built For Business</h1>
//                 <div className='flex justify-evenly items-center gap-1 bg-gradient-to-b from-slate-50/30 to-slate-100/40 w-[1180px] overflow-auto h-[437px] py-3 rounded-lg' >
//                 {
//                     visibleCardLength.map((val) => (
//                         <div className='flex  items-center flex-col gap-8 py-10 px-4 rounded-lg bg-white' > 
//                             <span style={{background : 'linear-gradient(314.65deg,#fd4df6 -.61%,#fda14d 100%)'}} className='w-20 flex items-center justify-center h-20 rounded-full  ' >
//                                 {val.icon}
//                             </span>
//                             <div className='flex items-center w-[250px] h-[220px] relative gap-3 flex-col' >
